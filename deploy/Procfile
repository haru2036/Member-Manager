...
#     echo '{ "name": "Member-Manager", "version": "0.0.1", "dependencies": {} }' >> package.json
#
...
#
#     git checkout deploy
#     git add ./dist/build/Member-Manager/Member-Manager
#     git commit -m deploy
#
# * push to Heroku
#
...
web: ./dist/build/Member-Manager/Member-Manager production -p $PORT
